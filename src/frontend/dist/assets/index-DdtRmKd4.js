...
function BassStabilizer({ isActive, bassLevel }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: enabled ? "STABILIZER ON" : "STABILIZER OFF"
          }
        )
      ]
    }
...
function FrequencyGenerator({ isActive }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              "LM3204",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 8, color: "rgba(255,215,0,0.6)" }, children: "FREQUENCY GENERATOR" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: FREQ_LABELS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  fontFamily: "Orbitron, sans-serif",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4 }, children: ["B", "M", "H", "P"].map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              display: "flex",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    animation: isActive ? `orbPulse ${0.8 + i * 0.2}s ease-in-out infinite` : "none"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "AUTO-CONNECTS ALL 4 ENGINES • dB SCALE"
          }
        )
      ]
    }
...
function HarmonicProcessor({ isActive }) {
  const canvasRef = reactExports.useRef(null);
  const rafRef = reactExports.useRef(null);
  const phaseRef = reactExports.useRef(0);
  reactExports.useEffect(() => {
    ...
    const draw = () => {
      ...
      if (isActive) {
        ...
        for (let x = 0; x < w; x++) {
          ...
          const y = h / 2 + Math.sin(t) * (h / 4) + Math.sin(t * 2) * (h / 8) + Math.sin(t * 3) * (h / 16);
          if (x === 0) ctx.moveTo(x, y);
          else ctx.lineTo(x, y);
        }
        ctx.stroke();
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "100% HARMONIC CORRECTION"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["H1", "H2", "H3"].map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  display: "flex",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        animation: isActive ? `orbPulse ${1 + i * 0.3}s ease-in-out infinite` : "none"
                      }
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: stats.map(({ label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    animation: isActive ? "meterBar1 1.5s ease-in-out infinite" : "none"
                  }
                }
              )
            }
...
function PowerStabilizer({ isActive }) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: 160, height: 90, viewBox: "0 0 160 90", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: 80, cy: 80, r: 5, fill: isActive ? "#FFD700" : "#2a3a5b" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: isActive ? "✓ AMP + APP STABILIZER ONLINE" : "STABILIZER OFFLINE"
          }
        )
      ]
    }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 5, zIndex: 1 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: isActive ? "ONLINE" : "OFFLINE"
            }
          )
        ] }),
        isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: METER_BARS.map(({ anim, key }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  width: 6,
...
function SpecialProcessor({ isActive }) {
  const [mode, setMode] = reactExports.useState("zero_distortion");
  const [noOverBass, setNoOverBass] = reactExports.useState(false);
  const [atMode, setAtMode] = reactExports.useState(true);
  const [btMode, setBtMode] = reactExports.useState(false);
  const buttons = [
      ...
      children: [
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                children: [
                  ...
                  mode === "zero_distortion" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "line",
                    {
                      x1: "0",
                      y1: "18",
                  ...
                  ) : mode === "no_clip" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "path",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: buttons.map(({ key, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  background: mode === key ? "rgba(255,215,0,0.15)" : "rgba(10,20,40,0.8)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8, justifyContent: "center" }, children: [
          { label: "AT", val: atMode, set: setAtMode },
          { label: "BT", val: btMode, set: setBtMode }
        ].map(({ label, val, set }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              ...
              background: noOverBass ? "rgba(255,153,0,0.15)" : "rgba(10,20,40,0.8)",
            ...
            children: noOverBass ? "● NO OVER BASS: ON" : "○ NO OVER BASS: OFF"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "EQ BAND: ALL THE WAY UP"
          }
        )
      ]
    }
...
function useAudioEngine() {
  ...
  const bypassBooster = reactExports.useCallback((bypass) => {
    if (boosterGainRef.current) {
      boosterGainRef.current.gain.value = bypass ? 1 : boosterValueRef.current;
    }
  }, []);
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          fontWeight: 600,
                          color: audioEngine.currentTrack ? "#FFD700" : "rgba(255,255,255,0.3)",
                          textAlign: "center",
                          flex: 1,
                          padding: "0 16px",
                          overflow: "hidden",
                        ...
                        children: audioEngine.currentTrack || "─── Select a track to begin ───"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(PowerStabilizer, { isActive: bothCharged && switches.STAB })
                        ]
                      }
                    ),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SpecialProcessor, { isActive: bothCharged && switches.COMP }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            BassStabilizer,
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(HarmonicProcessor, { isActive: bothCharged }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(FrequencyGenerator, { isActive: bothCharged })
                        ]
                      }
                    ),
