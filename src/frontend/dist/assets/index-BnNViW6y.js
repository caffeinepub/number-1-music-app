...
function BassStabilizer({
  ...
  const handleAmount = (v) => {
    setAmount(v);
    onAmountChange == null ? void 0 : onAmountChange(v);
  };
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: BAR_DEFS.map(({ id, mult, offset, animDelay }, idx) => {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        right: 0,
                        height: `${h * 100}%`,
                        background: active ? "linear-gradient(180deg, #00FF88, #00CC66)" : "linear-gradient(180deg, #FF4444, #CC2222)",
                        borderRadius: 3,
                        transition: "height 0.3s ease, background 0.4s",
                        animation: active ? `${ANIM_NAMES[idx]} ${animDelay} ease-in-out infinite` : "none"
                      }
                    }
                  )
                },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "eq-slider-container", style: { height: 80, width: 28 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "range",
...
function BatteryWidget({
  ...
  const [chargeLevel, setChargeLevel] = reactExports.useState(0);
  const intervalRef = reactExports.useRef(null);
  const chargeRef = reactExports.useRef(0);
  const onChargeChangeRef = reactExports.useRef(onChargeChange);
  onChargeChangeRef.current = onChargeChange;
  const totalDuration = id === 1 ? 8e3 : 1e4;
  const stepsRef = reactExports.useRef(totalDuration / 50);
  reactExports.useEffect(() => {
  ...
  const glowColor = isCharged ? "0 0 30px #FFD700, 0 0 60px #FFD700, 0 0 90px rgba(255,215,0,0.5)" : `0 0 ${glowIntensity * 0.3}px rgba(255,215,0,0.6), 0 0 ${glowIntensity}px rgba(255,215,0,0.2)`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: 120, height: 220 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  ...
                  right: 0,
                  height: `${chargeLevel}%`,
                  background: isCharged ? "linear-gradient(180deg, #FFE44D 0%, #FFD700 50%, #CC9900 100%)" : "linear-gradient(180deg, rgba(255,215,0,0.9) 0%, rgba(255,180,0,0.7) 60%, rgba(200,140,0,0.5) 100%)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  position: "absolute",
                  inset: 0,
                  backgroundImage: "repeating-linear-gradient(0deg, rgba(255,215,0,0.05) 0px, rgba(255,215,0,0.05) 1px, transparent 1px, transparent 10px)",
                  pointerEvents: "none"
                }
              }
            ),
      ...
      !isCharged && ARC_POSITIONS.map((pos) => {
        const { key, ...style2 } = pos;
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
              position: "absolute",
              ...style2,
              background: isHorizontal ? "linear-gradient(90deg, transparent, #FFD700, transparent)" : "linear-gradient(180deg, transparent, #00BFFF, transparent)",
              borderRadius: 2,
      ...
      isCharged && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            position: "absolute",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: isCharged ? "CHARGED ✓" : "CHARGING..."
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at 30% 30%, #0d2a6b 0%, #050d1f 60%), radial-gradient(ellipse at 70% 70%, #1a0a00 0%, transparent 50%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 0 30px rgba(255,215,0,0.4), inset 0 0 30px rgba(255,215,0,0.05)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        CORNERS.map((pos, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center justify-center gap-6 px-12 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 text-3xl", style: { color: "#FFD700" }, children: "★ ★ ★ ★ ★" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                ...
                fontWeight: 900,
                lineHeight: 1.1,
                background: "linear-gradient(90deg, #CC9900, #FFD700, #FFE44D, #FFD700, #CC9900)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "Powered by Advanced Sound Engineering"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 text-xl", style: { color: "#FFD700" }, children: "★ ★ ★" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "text-sm",
...
function ChainLink({ eqValues }) {
  ...
  const links = Array.from({ length: numLinks }, (_, i) => {
    ...
    const distortOffset = normalizedDistortion * Math.sin(i / numLinks * Math.PI * 2) * 8;
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflowX: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "EQ chain link visualization" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: "chainGlow", children: [
              ...
              links.map(({ cx, cy, isVertical, scaleX, scaleY, idx }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "ellipse",
                {
                  cx,
                  cy,
                  rx: isVertical ? linkHeight / 2 * scaleX : linkWidth / 2 * scaleX,
                  ry: isVertical ? linkWidth / 2 * scaleY : linkHeight / 2 * scaleY,
              ...
              normalizedDistortion > 0.1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "text",
                {
                  x: svgWidth / 2,
                  y: svgHeight - 4,
                  ...
                  children: [
                    "TENSION: ",
                    Math.round(normalizedDistortion * 100),
                    "%"
                  ]
                }
              )
...
const BRANCH_X = [110, 230, 370, 490];
const BRANCH_KEYS = ["bass", "mid", "high", "presence"];
function CircuitLines({ powered }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Circuit power lines" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              ...
              powered && /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "flowGrad", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#FFD700", stopOpacity: "0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "50%", stopColor: "#FFD700", stopOpacity: "1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#FFD700", stopOpacity: "0" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                ...
                strokeOpacity,
                filter: powered ? `url(#${glowId})` : void 0
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
            ...
            BRANCH_X.map((x, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: x,
                y1: "30",
            ...
            powered && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { r: "4", fill: "#FFD700", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "animateMotion",
                {
                  dur: "1.5s",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { r: "3", fill: "#FFE44D", opacity: "0.8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "animateMotion",
                {
                  dur: "1s",
                  repeatCount: "indefinite",
...
function Epicenter({ isActive, onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "epic-slider-container", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "epic-center-tick" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "range",
...
function FrequencyGenerator({
  ...
  const [freq, setFreq] = reactExports.useState(60);
  const [mix, setMix] = reactExports.useState(0);
  const handleFreq = (v) => {
    setFreq(v);
    onToneChange == null ? void 0 : onToneChange(v, mix);
  };
  const handleMix = (v) => {
    setMix(v);
    onToneChange == null ? void 0 : onToneChange(freq, v);
  };
  reactExports.useEffect(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: FREQ_LABELS.map((label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  fontFamily: "Orbitron, sans-serif",
...
function HarmonicProcessor({
  ...
  const rafRef = reactExports.useRef(null);
  const phaseRef = reactExports.useRef(0);
  const [drive, setDrive] = reactExports.useState(0);
  const handleDrive = (v) => {
    setDrive(v);
    onDriveChange == null ? void 0 : onDriveChange(v);
  };
  reactExports.useEffect(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
    ...
    const draw = () => {
      ...
      if (isActive) {
        ...
        for (let x = 0; x < w; x++) {
          ...
          const y = h / 2 + Math.sin(t) * (h / 4) * driveFactor + Math.sin(t * 2) * (h / 8) + Math.sin(t * 3) * (h / 16);
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    textShadow: isActive ? `0 0 6px ${drive > 30 ? "#FFD700" : "#00FF88"}` : "none"
                  },
                  children: [
                    drive,
                    "%"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "WAVESHAPER · HARMONIC DIST"
          }
        )
      ]
    }
...
function MonitorCompressor({
  ...
  const [ratio, setRatio] = reactExports.useState(12);
  const [attack, setAttack] = reactExports.useState(3);
  const [release, setRelease] = reactExports.useState(250);
  ...
  const handleRatio = (v) => {
    setRatio(v);
    onRatioChange == null ? void 0 : onRatioChange(v);
  };
  const handleAttack = (v) => {
    setAttack(v);
    onAttackChange == null ? void 0 : onAttackChange(v / 1e3);
  };
  const handleRelease = (v) => {
    setRelease(v);
    onReleaseChange == null ? void 0 : onReleaseChange(v / 1e3);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "100% HARMONIC PROCESSOR"
          }
        ),
...
function PlaybackControls({
  ...
  const handleSelectMouseLeave = (e) => {
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: currentTrack || "No track loaded"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              title: !isEnabled ? "⚡ Charge batteries first" : void 0,
              style: {
                width: 56,
                height: 56,
                borderRadius: "50%",
                background: isEnabled ? isPlaying ? "linear-gradient(135deg, #FFD700, #FF9900)" : "linear-gradient(135deg, #FFD700, #FFE44D)" : "#1a3a6b",
                border: "none",
                cursor: isEnabled ? "pointer" : "not-allowed",
                fontSize: 22,
                display: "flex",
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: (e) => isEnabled && onSeek(Number.parseFloat(e.target.value))
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "vol-amp-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "range",
        ...
        !isEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "⚡ Charge both batteries to enable playback"
          }
        )
      ]
    }
...
function PowerStabilizer({
  isActive,
  onActiveChange
}) {
  const [needleAngle, setNeedleAngle] = reactExports.useState(-90);
  const [power, setPower] = reactExports.useState(0);
  const [limiterOn, setLimiterOn] = reactExports.useState(true);
  const rafRef = reactExports.useRef(null);
  ...
  const handleToggle = () => {
    ...
    setLimiterOn(next);
    onActiveChange == null ? void 0 : onActiveChange(next);
  };
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "80,000W POWER STABILIZER"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: 160, height: 90, viewBox: "0 0 160 90", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "80000W Power stabilizer gauge" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "80", cy: "80", r: "5", fill: isActive ? "#FFD700" : "#1a3a6b" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            style: {
              ...
              fontSize: 8,
              padding: "5px 12px",
              background: limiterOn ? "linear-gradient(180deg, rgba(255,215,0,0.2), rgba(255,215,0,0.05))" : "rgba(0,0,0,0.4)",
...
function SmartChipPanel({
  ...
  const [boostWatts, setBoostWatts] = reactExports.useState(375);
  const [volPct, setVolPct] = reactExports.useState(100);
  const [enhance, setEnhance] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  const handleBoost = (v) => {
    ...
    setBoostWatts(watts);
    onBoostChange == null ? void 0 : onBoostChange(v);
  };
  const handleVol = (v) => {
    setVolPct(Math.round(v * 100));
    onVolumeChange == null ? void 0 : onVolumeChange(v);
  };
  const handleEnhance = (v) => {
    setEnhance(v);
    onEnhanceChange == null ? void 0 : onEnhanceChange(v);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              inset: 0,
              backgroundImage: "repeating-linear-gradient(0deg,rgba(0,191,255,0.04) 0,rgba(0,191,255,0.04) 1px,transparent 1px,transparent 16px),repeating-linear-gradient(90deg,rgba(0,191,255,0.04) 0,rgba(0,191,255,0.04) 1px,transparent 1px,transparent 16px)",
              pointerEvents: "none"
            }
          }
        ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                                inset: 4,
                                backgroundImage: "repeating-linear-gradient(0deg,rgba(0,191,255,0.12) 0,rgba(0,191,255,0.12) 1px,transparent 1px,transparent 8px),repeating-linear-gradient(90deg,rgba(0,191,255,0.12) 0,rgba(0,191,255,0.12) 1px,transparent 1px,transparent 8px)",
                                borderRadius: 2
                              }
                            }
                          ),
                          ...
                          LEFT_PINS.map((top) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                          ...
                          RIGHT_PINS.map((top) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 6, textAlign: "center" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["PWR", "CLK", "SIG"].map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  display: "flex",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        animation: isActive ? `orbPulse ${1.2 + i * 0.3}s ease-in-out infinite` : "none"
                      }
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function SoundEnginePanel({
  ...
  const [gainDb, setGainDb] = reactExports.useState(0);
  const handleGain = (v) => {
    setGainDb(v);
    onGainChange == null ? void 0 : onGainChange(engineType, v);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        width: 150,
        minHeight: 180,
        background: isActive ? "linear-gradient(135deg, #0d2040 0%, #0a1628 100%)" : "#070f22",
        border: `2px solid ${isActive ? "#FFD700" : "#1a3a6b"}`,
        borderRadius: 10,
        padding: "10px",
        display: "flex",
        ...
        position: "relative",
        overflow: "hidden",
        boxShadow: isActive ? "0 0 20px rgba(255,215,0,0.3), 0 0 40px rgba(255,215,0,0.1)" : "none",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 22, zIndex: 1 }, children: icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 5, zIndex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: METER_BARS.map(({ key, anim }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  width: 10,
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      ...
                      background: isActive ? "linear-gradient(180deg, #FFD700, #FF8800)" : "#1a3a6b",
                      borderRadius: 2,
                      marginTop: "auto",
                      animation: isActive ? `${anim} 1.4s ease-in-out infinite` : "none",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    textShadow: isActive ? `0 0 6px ${gainDb > 0 ? "#FFD700" : "#00BFFF"}` : "none"
                  },
                  children: [
...
function SpecialProcessor({
  ...
  const [mode, setProcMode] = reactExports.useState("AT");
  const [intensity, setIntensity] = reactExports.useState(50);
  const handleMode = (m) => {
    setProcMode(m);
    onModeChange == null ? void 0 : onModeChange(m, intensity);
  };
  const handleIntensity = (v) => {
    setIntensity(v);
    onModeChange == null ? void 0 : onModeChange(mode, v);
  };
  const modeColors = {
    AT: "#00BFFF",
    BT: "#FFD700"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              "SPECIAL PROCESSOR",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 7, color: "rgba(255,215,0,0.6)" }, children: "SUPER MODERN · CLEAR CLARITY" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                preserveAspectRatio: "none",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Processor signal waveform" }),
                  mode === "AT" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "polyline",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8 }, children: ["AT", "BT"].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            style: {
              ...
              fontWeight: 700,
              padding: "5px 14px",
              background: mode === m ? `linear-gradient(180deg, ${modeColors[m]}33, ${modeColors[m]}11)` : "rgba(0,0,0,0.3)",
              border: `2px solid ${mode === m ? modeColors[m] : "#1a3a6b"}`,
              borderRadius: 6,
              color: mode === m ? modeColors[m] : "rgba(255,255,255,0.4)",
              cursor: "pointer",
              letterSpacing: "0.15em",
              boxShadow: mode === m && isActive ? `0 0 12px ${modeColors[m]}66` : "none",
              transition: "all 0.2s"
            },
            children: m
          },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "eq-slider-container", style: { height: 90, width: 28 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "range",
                  className: "eq-vert-slider",
...
function StereoLineMixer({
  onPanChange,
  isActive
}) {
  const [panVal, setPanVal] = reactExports.useState(0);
  const handlePan = (v) => {
    setPanVal(v);
    onPanChange(v);
  };
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            ].map(({ label, level }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  display: "flex",
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            animation: isActive ? "meterBar1 1.3s ease-in-out infinite" : "none"
                          }
                        }
                      )
                    }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                "PAN:",
                " ",
                panVal === 0 ? "CENTER" : panVal > 0 ? `R${Math.round(panVal * 100)}` : `L${Math.round(-panVal * 100)}`
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              style: {
                ...
                width: "100%",
                height: 6,
                background: "linear-gradient(to right, #0a1e3d 0%, #ffd700 50%, #0a1e3d 100%)",
                borderRadius: 3,
...
function StudioSwitches({ switches, onToggle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "◈ STUDIO BUTTON SWITCHES"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: SWITCH_DEFS.map(({ key, label }, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    ...
                    alignItems: "center",
                    gap: 8,
                    background: on ? "linear-gradient(180deg, rgba(255,215,0,0.2), rgba(255,215,0,0.05))" : "linear-gradient(180deg, rgba(10,20,50,0.8), rgba(5,13,31,0.8))",
                    border: `2px solid ${on ? "#FFD700" : "#1a3a6b"}`,
                    borderRadius: 10,
                    padding: "14px 18px",
                    cursor: "pointer",
                    boxShadow: on ? "0 0 20px rgba(255,215,0,0.4), inset 0 0 10px rgba(255,215,0,0.1)" : "none",
                    transition: "all 0.2s",
                    minWidth: 64
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: 24, height: 40 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            width: 10,
                            height: 40,
                            background: on ? "rgba(255,215,0,0.3)" : "rgba(10,20,50,0.8)",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            width: 18,
                            height: 18,
                            background: on ? "radial-gradient(circle, #FFE44D, #FFD700, #CC9900)" : "#1a3a6b",
                            borderRadius: 4,
                            boxShadow: on ? "0 0 10px #FFD700, 0 0 20px rgba(255,215,0,0.5)" : "none",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        borderRadius: 10,
        overflow: "hidden",
        boxShadow: "0 0 20px rgba(255,215,0,0.1), inset 0 0 20px rgba(0,0,50,0.5)",
        position: "relative"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function useAudioEngine() {
  ...
  const boosterGainRef = reactExports.useRef(null);
  const filtersRef = reactExports.useRef({});
  const filterGainsRef = reactExports.useRef({});
  const engineFiltersRef = reactExports.useRef({});
  const analyserRef = reactExports.useRef(null);
  const compressorRef = reactExports.useRef(null);
  const pannerRef = reactExports.useRef(null);
  const startTimeRef = reactExports.useRef(0);
  const pauseOffsetRef = reactExports.useRef(0);
  const intervalRef = reactExports.useRef(null);
  const boosterValueRef = reactExports.useRef(1);
  const bassStabCompRef = reactExports.useRef(null);
  const waveShaperRef = reactExports.useRef(null);
  const powerLimiterRef = reactExports.useRef(null);
  const specialProcFilterRef = reactExports.useRef(null);
  const smartChipFilterRef = reactExports.useRef(null);
  const subOscRef = reactExports.useRef(null);
  const subGainRef = reactExports.useRef(null);
  const subOscStartedRef = reactExports.useRef(false);
  const [isPlaying, setIsPlaying] = reactExports.useState(false);
  const [currentTime, setCurrentTime] = reactExports.useState(0);
  const [duration, setDuration] = reactExports.useState(0);
  const [currentTrack, setCurrentTrack] = reactExports.useState("");
  const getOrCreateContext = reactExports.useCallback(() => {
  ...
  const buildGraph = reactExports.useCallback(() => {
    ...
    const engineDefs = [
      ...
      { key: "midEngine", type: "peaking", freq: 1e3 },
      { key: "highEngine", type: "highshelf", freq: 8e3 },
      { key: "presenceEngine", type: "peaking", freq: 6e3 }
    ];
    const engineFilters = engineDefs.map(
      ({ key, type, freq }) => {
    ...
    smartChipFilter.frequency.value = 12e3;
    ...
    specialProcFilter.frequency.value = 1e3;
    ...
    const filterDefs = [
      ...
      { key: "mid", type: "peaking", freq: 1e3 },
      { key: "midHigh", type: "peaking", freq: 3500 },
      { key: "treble", type: "highshelf", freq: 8e3 },
      { key: "presence", type: "peaking", freq: 6e3 }
    ];
    const filters = filterDefs.map(
      ({ key, type, freq }) => {
        const f = ctx.createBiquadFilter();
        f.type = type;
        f.frequency.value = freq;
    ...
    bassStabComp.attack.value = 5e-3;
    ...
    powerLimiter.attack.value = 1e-3;
  ...
  const seek = reactExports.useCallback(
    (time) => {
  ...
  const bypassCompressor = reactExports.useCallback((bypass) => {
  ...
  const bypassBooster = reactExports.useCallback((bypass) => {
    if (boosterGainRef.current) {
      boosterGainRef.current.gain.value = bypass ? 0 : boosterValueRef.current;
    }
  }, []);
  const setEpicenterIntensity = reactExports.useCallback((v) => {
  ...
  const setBassStabilizerAmount = reactExports.useCallback((v) => {
  ...
  const setHarmonicDrive = reactExports.useCallback((v) => {
    ...
    if (v === 0) {
      ...
      ws.curve = makeDistortionCurve(v / 100);
    }
  }, []);
  const setFreqGenTone = reactExports.useCallback((freq, mix) => {
    if (subOscRef.current) {
      subOscRef.current.frequency.value = freq;
    }
    if (subGainRef.current) {
      subGainRef.current.gain.value = mix / 100 * 0.3;
    }
  }, []);
  const setPowerStabilizerActive = reactExports.useCallback((active) => {
  ...
  const setSpecialProcessorMode = reactExports.useCallback(
    (mode, intensity) => {
      const f = specialProcFilterRef.current;
      if (!f) return;
      if (mode === "AT") {
        f.type = "bandpass";
        f.frequency.value = 1e3 + intensity / 100 * 4e3;
        f.Q.value = 1 + intensity / 100 * 4;
      } else {
        f.type = "allpass";
        f.frequency.value = 500 + intensity / 100 * 2e3;
        f.Q.value = 0.5 + intensity / 100 * 2;
      }
    },
    []
  );
  const setCompressorRatio = reactExports.useCallback((v) => {
    if (compressorRef.current) compressorRef.current.ratio.value = v;
  }, []);
  const setCompressorAttack = reactExports.useCallback((v) => {
    if (compressorRef.current) compressorRef.current.attack.value = v;
  }, []);
  const setCompressorRelease = reactExports.useCallback((v) => {
    if (compressorRef.current) compressorRef.current.release.value = v;
  }, []);
  const setSmartChipEnhance = reactExports.useCallback((v) => {
    const f = smartChipFilterRef.current;
    if (!f) return;
    f.gain.value = v / 100 * 12;
  }, []);
  reactExports.useEffect(() => {
    return () => {
      if (subOscRef.current && subOscStartedRef.current) {
...
function App() {
  ...
  const [battery1Level, setBattery1Level] = reactExports.useState(0);
  const [battery2Level, setBattery2Level] = reactExports.useState(0);
  const [switches, setSwitches] = reactExports.useState({
    COMP: true,
    STAB: true,
    EPIC: true,
    AMP: true,
  ...
  const analyserNodeRef = reactExports.useRef(audioEngine.analyserNode);
  ...
  const handleToggleSwitch = reactExports.useCallback(
    (key) => {
      setSwitches((prev) => {
        ...
        if (key === "COMP") {
          ...
          else audioEngine.setBoosterGain(1);
  ...
  const handleEpicenterChange = reactExports.useCallback(
    (v) => {
      if (switches.EPIC) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
              inset: 0,
              background: "radial-gradient(ellipse at 20% 20%, rgba(0,50,150,0.15) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(255,150,0,0.05) 0%, transparent 50%)",
              pointerEvents: "none",
              zIndex: 0
            }
          }
        ),
        showCover && /* @__PURE__ */ jsxRuntimeExports.jsx(BookCover, { onComplete: () => setShowCover(false) }),
        !showCover && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "relative",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: "◈ NUMBER 1 WINNING MUSIC APP"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                ...
                "main",
                {
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "battery.1_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  BatteryWidget,
                                  {
                                    id: 1,
                                    label: "POWER CELL A",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "div",
                                  {
                                    ...
                                    children: [
                                      !bothCharged ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                        "div",
                                        {
                                          style: {
                                            textAlign: "center",
                                      ...
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6 }, children: ["120W", "40W"].map((fuse) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                        "div",
                                        {
                                          style: {
                                            fontFamily: "Orbitron, sans-serif",
                                            fontSize: 7,
                                            color: bothCharged ? "#FFD700" : "rgba(255,215,0,0.3)",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "battery.2_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  BatteryWidget,
                                  {
                                    id: 2,
                                    label: "POWER CELL B",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircuitLines, { powered: bothCharged }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                          ...
                          ].map(({ name, type }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `engine.${type}_panel`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            SoundEnginePanel,
                            {
                              name,
                              engineType: type,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(StudioSwitches, { switches, onToggle: handleToggleSwitch }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChainLink, { eqValues: {} }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      PlaybackControls,
                      {
